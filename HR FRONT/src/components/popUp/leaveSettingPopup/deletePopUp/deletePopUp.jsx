  ...
  return (
    <div className="popUpContainer z-50 flex justify-center align-middle fixed top-0 left-0">
      <div className="popUp w-full lg:w-[30%] md:w-[70%] bg-white p-4 md:p-10 flex flex-col drop-shadow-lg gap-5 m-auto">
        ...
        <div className="mb-9">
          <p className="text-center mb-2 sm:mb-4 confirmText">Are you sure you want to delete <span className="highlighted-text">{editData.leaveType} </span>?</p>
        </div>
        <div className="flex justify-evenly">
          <button className="delete-btn py-2 rounded-md w-[40%] sm:w-[40%] md:w-[30%]" onClick={() => deleteLeaveHandler(editData?._id)}>Delete</button>
